...
public class WebCoreActivity extends AppCompatActivity {
    ...
    @Bind(R.id.pb_bar)
    ProgressBar pbBar;
    @Bind(R.id.tbs_content)
    com.tencent.smtt.sdk.WebView tbsContent;
    @Bind(R.id.content_web_core)
    RelativeLayout contentWebCore;
    private java.lang.String InputUrl = "http://m.baidu.com";
    private java.lang.String Title = "";//默认为空时，则自动读取html页面title标签数据，一般为空即可
    Toolbar toolbar;
